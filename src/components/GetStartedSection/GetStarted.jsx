        ...
        <div className='w-full py-30 bg-[#F9FAFC]'>
            <div className='max-w-300 mx-auto flex flex-col gap-10 justify-center items-center '>
                ...
                <div className='flex justify-center items-center gap-7 text-center'>
                    <div className='flex relative flex-col justify-center items-center gap-4 border border-[#F1F1F1] rounded-2xl py-22 px-6 bg-white'>
                    ...
                    <div className='relative flex flex-col justify-center items-center gap-4 border border-[#F1F1F1] rounded-2xl py-22 px-6 bg-white'>
                        <div className='w-8 h-8 rounded-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] absolute flex justify-center items-center top-5 right-5 text-white'>
                            02
                        </div>
