...
const State = () => {
    return (
        <div className='h-61.75 w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] flex justify-center'>
            <div className='w-full max-w-300 flex justify-center items-center mx-auto'>
